...
Here I'm using PowerShell core on Linux, you can use PS on WIN as well, however if you want to install the PowerShell Liunx version follow the steps here: [Install PowerShell core](https://www.powershellgallery.com/packages/PSFolderSize/1.7.1)
