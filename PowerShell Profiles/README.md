...
## Problems solved:
  ...
  - **Senario 02:** You have multiple scripts in your environment, and you have some variables, and functinos that you're using continuously in each script, So you're definning in each script the same variables and functions,etc. in short period you'll figure out that your script become complix; To make the script simple in as posible you can define all those variables and function in PowerShell profile and just recall it in your script.
